...
class ExampleTests {
    ...
    // right: 直接启动 JettyServerLauncher 类, 并设置 module 为 tenancy_main
    @Test
    fun testJettyServer() {
        // wrong: 无法加载 tenancy/src/main/webapp
        JettyServer().start()
    }

    @Test
    fun testCodeModel() {
        val generator = ModelGenerator("/home/shi/code/java/jkmvc/tenancy/src/main/kotlin" /* 源码目录 */, "net.jkcode.jkmvc.example.model" /* 包路径 */, "default" /* 数据库名 */, "shijianhang" /* 作者 */)
